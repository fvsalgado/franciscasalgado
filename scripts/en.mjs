...
export const EN = {
  ...
  rc_ct_txt: 'Write to <a class="lig" href="mailto:birdie@franciscasalgado.golf?subject=Francisca%20Salgado">birdie@franciscasalgado.golf</a>. Swing videos, transcripts and whatever else an evaluation needs — just ask.',
  ...
  rs_txt: 'From her first federated event in 2018 to the national U18 title — every season told, event by event.',
  im_rot: 'Press',
  im_tit: 'For people who write about golf',
  im_txt: 'Everything a story needs, ready to use: a short biography, sourced facts and quotes in her own words. High-resolution photographs? Just ask.',
